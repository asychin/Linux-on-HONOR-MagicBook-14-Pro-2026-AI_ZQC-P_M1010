 ...
 */
DefinitionBlock ("", "SSDT", 2, "HONOR", "Ther_Rvp", 0x00001000)
{
    External (_SB_.AAC0, UnknownObj)
    External (_SB_.ACRT, UnknownObj)
    External (_SB_.APSV, UnknownObj)
    External (_SB_.PC00.LPCB.LXEC.ECHR, UnknownObj)
    External (_SB_.PC00.LPCB.LXEC.ECHT, UnknownObj)
    External (_SB_.PC00.LPCB.LXEC.GHSF, UnknownObj)
    ...
    Scope (\_TZ)
    {
        ...
        ThermalZone (TZ00)
        {
            ...
            Method (_TMP, 0, Serialized)  // _TMP: Temperature
            {
                ...
                If ((\_SB.PC00.LPCB.LXEC.GHSF == Zero))
                {
                    If ((\_SB.PC00.LPCB.LXEC.ECHT == One))
                    {
                        If ((\_SB.PC00.LPCB.LXEC.ECHR > 0x2A))
                        {
                            \_SB.PC00.LPCB.LXEC.ECHT = Zero
                            \_SB.PC00.LPCB.LXEC.ECHR = Zero
                            \_SB.PC00.LPCB.LXEC.GHSF = Zero
                            Local0 = 0x65
