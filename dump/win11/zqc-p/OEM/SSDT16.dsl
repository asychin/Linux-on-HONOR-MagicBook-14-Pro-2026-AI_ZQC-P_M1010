 ...
 */
DefinitionBlock ("", "SSDT", 2, "HONOR", "MiCaTabl", 0x00001000)
{
    ...
    External (_SB_.PC00.DSCR, MethodObj)    // 1 Arguments
    ...
    Scope (\_SB)
    {
        OperationRegion (MNVS, SystemMemory, 0x6FDC5000, 0x0486)
        ...
        Method (GPAD, 3, Serialized)
        {
            ...
            Local2 = Zero
            Local0 = Zero
            Local1 = ((CHID & 0x1F) << 0x11)
            Local2 = Zero
            Local3 = ((Arg0 & 0x07) << 0x0A)
            Local4 = ((Arg1 & 0x07) << 0x07)
            Local5 = ((Arg2 & 0x7F) << Zero)
        ...
        Device (DSC0)
        {
            ...
            If (((C0GP != Zero) || (\_SB.PC00.LNKC (_UID) != Zero)))
            {
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    If ((\_SB.PC00.LNKC (_UID) != Zero))
                    {
                        Return (\_SB.PC00.DSCR (_UID))
                    }

                    If ((C0GP > Zero))
                    {
                        Local0 = PINR (C0C0, C0G0, C0P0)
                    }

                    If ((C0GP > One))
                    {
                        Local1 = PINR (C0C1, C0G1, C0P1)
            ...
            Method (CLDB, 0, NotSerialized)
            {
                ...
                PAR [0x05] = PLID /* \_SB_.PLID */
                PAR [0x06] = EMUS /* \_SB_.EMUS */
        ...
        Device (DSC1)
        {
            ...
            If (((C1GP != Zero) || (\_SB.PC00.LNKC (_UID) != Zero)))
            {
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    If ((\_SB.PC00.LNKC (_UID) != Zero))
                    ...
                    If ((C1GP > Zero))
                    {
                        Local0 = PINR (C1C0, C1G0, C1P0)
                    }

                    If ((C1GP > One))
                    {
                        Local1 = PINR (C1C1, C1G1, C1P1)
                        ConcatenateResTemplate (Local0, Local1, Local2)
                        Local0 = Local2
                    }
        ...
        Device (DSC2)
        {
            ...
            If (((C2GP != Zero) || (\_SB.PC00.LNKC (_UID) != Zero)))
            {
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    If ((\_SB.PC00.LNKC (_UID) != Zero))
                    ...
                    If ((C2GP > Zero))
                    {
                        Local0 = PINR (C2C0, C2G0, C2P0)
                    }

                    If ((C2GP > One))
                    {
                        Local1 = PINR (C2C1, C2G1, C2P1)
                        ConcatenateResTemplate (Local0, Local1, Local2)
                        Local0 = Local2
                    }
        ...
        Device (DSC3)
        {
            ...
            If (((C3GP != Zero) || (\_SB.PC00.LNKC (_UID) != Zero)))
            {
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    If ((\_SB.PC00.LNKC (_UID) != Zero))
                    ...
                    If ((C3GP > Zero))
                    {
                        Local0 = PINR (C3C0, C3G0, C3P0)
                    }

                    If ((C3GP > One))
                    {
                        Local1 = PINR (C3C1, C3G1, C3P1)
                        ConcatenateResTemplate (Local0, Local1, Local2)
                        Local0 = Local2
                    }
        ...
        Device (DSC4)
        {
            ...
            If (((C4GP != Zero) || (\_SB.PC00.LNKC (_UID) != Zero)))
            {
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    If ((\_SB.PC00.LNKC (_UID) != Zero))
                    ...
                    If ((C4GP > Zero))
                    {
                        Local0 = PINR (C4C0, C4G0, C4P0)
                    }

                    If ((C4GP > One))
                    {
                        Local1 = PINR (C4C1, C4G1, C4P1)
                        ConcatenateResTemplate (Local0, Local1, Local2)
                        Local0 = Local2
                    }
        ...
        Device (DSC5)
        {
            ...
            If (((C5GP != Zero) || (\_SB.PC00.LNKC (_UID) != Zero)))
            {
                Method (_CRS, 0, NotSerialized)  // _CRS: Current Resource Settings
                {
                    If ((\_SB.PC00.LNKC (_UID) != Zero))
                    ...
                    If ((C5GP > Zero))
                    {
                        Local0 = PINR (C5C0, C5G0, C5P0)
                    }

                    If ((C5GP > One))
                    {
                        Local1 = PINR (C5C1, C5G1, C5P1)
                        ConcatenateResTemplate (Local0, Local1, Local2)
                        Local0 = Local2
                    }
            ...
            Method (CLDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x20)
                {
                    /* 0000 */  0x00, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0008 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0010 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,  // ........
                    /* 0018 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00   // ........
                })
        ...
        Device (LNK0)
        {
            ...
            Method (SSDB, 0, NotSerialized)
            {
                Name (PAR, Buffer (0x6C)
                {
                    ...
                    /* 0050 */  0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00,  // ........
                ...
                PAR [0x50] = PLID /* \_SB_.PLID */
                PAR [0x51] = EMUS /* \_SB_.EMUS */
                ...
                If (CondRefOf (L0PV))
                {
                    PAR [0x61] = L0PV /* \_SB_.L0PV */
                }

                If (CondRefOf (L0PU))
                {
                    PAR [0x62] = L0PU /* \_SB_.L0PU */
                }
        ...
        Device (LNK1)
        {
            ...
            Method (SSDB, 0, NotSerialized)
            {
                ...
                If (CondRefOf (L1PV))
                {
                    PAR [0x61] = L1PV /* \_SB_.L1PV */
                }

                If (CondRefOf (L1PU))
                {
                    PAR [0x62] = L1PU /* \_SB_.L1PU */
                }
        ...
        Device (LNK2)
        {
            ...
            Method (SSDB, 0, NotSerialized)
            {
                ...
                If (CondRefOf (L2PV))
                {
                    PAR [0x61] = L2PV /* \_SB_.L2PV */
                }

                If (CondRefOf (L2PU))
                {
                    PAR [0x62] = L2PU /* \_SB_.L2PU */
                }
        ...
        Device (FLM0)
        {
            ...
            Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
            {
                ...
                If ((Arg0 == ToUUID ("dc49b5aa-e51d-4926-9b86-a6a908d8acf3") /* Unknown UUID */))
                {
                    Return (EMUS) /* \_SB_.EMUS */
                }
