 ...
 */
DefinitionBlock ("", "SSDT", 2, "HONOR", "Tpm2Tabl", 0x00001000)
{
    Scope (\_SB)
    {
        Device (TPM)
        {
            ...
            OperationRegion (TNVS, SystemMemory, 0x6FDDD000, 0x30)
            ...
            OperationRegion (CONA, SystemMemory, 0x6FDDD030, 0x30)
            ...
            OperationRegion (STRT, SystemMemory, 0x6FDDD060, 0x04)
